...
tag=`micro_ab` shots=4096 n_train=20 twin=default ansatz=ecd params=both families=loss kappa=0.003,0.1
...
| ecd | random | loss | 0.1 | readout_realistic | 0.3024 | 0.3900 | 0.2887 | gdr_damped | 0.2978 | 0.3940 | -0.1013 |
