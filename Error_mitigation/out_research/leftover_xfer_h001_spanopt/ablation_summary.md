...
tag=`leftover_xfer_h001_spanopt` shots=8192 n_train=40 twin=span ansatz=ecd params=optimized families=comprehensive kappa=0.1
...
ecd   optimized comprehensive          0.100 ideal              gdr_select           0.8290   2.5621
...
ecd   optimized comprehensive          0.100 readout_strong     gdr_select           0.8336   2.6501
```
